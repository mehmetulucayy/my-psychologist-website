  ...
  return (
    <div className="container mx-auto px-4 py-16">
      ...
      <div className="max-w-3xl mx-auto text-lg leading-relaxed text-gray-700">
        ...
        <p className="mb-4">
          Amacımız, bilimsel temellere dayalı terapi yaklaşımlarını kullanarak, danışanlarımızın içsel kaynaklarını keşfetmelerine, zorluklarla başa çıkma becerilerini geliştirmelerine ve daha anlamlı bir yaşam sürmelerine yardımcı olmaktır.
        </p>
        <p>
          Sağlıklı bir zihin, mutlu bir yaşamın anahtarıdır. Bu yolculukta yanınızda olmaktan mutluluk duyarız.
        </p>
      </div>
    </div>
  );
